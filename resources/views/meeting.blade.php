...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="themes/adminlte/index3.html" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="themes/adminlte/index3.html" class="brand-link">
      <img src="themes/adminlte/dist/img/AdminLTELogo.png"
           alt="AdminLTE Logo"
